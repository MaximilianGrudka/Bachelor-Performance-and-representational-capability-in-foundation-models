...
class VitExtractor:
    ...
    def get_patch_size(self):
        if "14" in self.model_name: return 14 
        elif "8" in self.model_name: return 8
        else: return 16
    ...
    def get_head_num(self):
        if "base" in self.model_name: return 12 
        elif "small" in self.model_name: return 6
        elif "tiny" in self.model_name: return 3
        else: return 16

    def get_embedding_dim(self):
        if "large" in self.model_name: return 1024 
        elif "small" in self.model_name: return 384
        elif "tiny" in self.model_name: return 192
        else: return 768
