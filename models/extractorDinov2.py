...
class VitExtractor:
    ...
    def get_patch_size(self):
        if "vitl" in self.model_name: return 14 
        elif "vits" in self.model_name: return 14
        else: return 16
    ...
    def get_head_num(self):
        return 16 if "vitl" in self.model_name else 12

    def get_embedding_dim(self):
        if "vitl" in self.model_name: return 1024 
        elif "vits" in self.model_name: return 384
        else: return 768
