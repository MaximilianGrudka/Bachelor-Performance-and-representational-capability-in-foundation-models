from models.extractorDinov2 import VitExtractor
...
def invert(args):
    ...
    net_input_saved = torch.randn((1, args.input_depth, 224, 224)).to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--feature", type=str, help='feature to invert. options: cls | keys')
    parser.add_argument("--layer", type=int, default=11,
                        help='Transformer layer from which to extract the feature, between 0-11')
    parser.add_argument("--image_path", type=str, default='datasets/imagenet-1k/ILSVRC2012_val_00000001.JPEG',
